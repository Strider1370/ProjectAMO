...
| `monitoring` | `MonitoringPage.jsx`, TAF worsening alerts | desktop, iPad landscape | local monitoring data; TAF fixture provides new/previous structure; mobile is redirected away from /monitoring | `frontend/verification/contracts/monitoring.spec.mjs` | frontend | active — passed 2026-07-28 (23 passed, 13 skipped) |
