...
- 스펙: `docs/archive/development/specs/2026-07-26-radar-echo-motion-arrows-design.md`. 충돌 시 스펙이 우선한다.
...
- `docs/archive/development/status/radar-echo-motion-arrows.status.md` — 게이트 A 결과
