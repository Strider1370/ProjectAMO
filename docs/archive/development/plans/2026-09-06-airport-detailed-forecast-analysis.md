...
계획 검토에서 파일·인터페이스·수용 기준 누락을 해결한 뒤 사용자 검토에 넘긴다. 실제 실행을 요청받으면 Task 1부터 진행하고, 각 완료 작업과 검증 증거는 `docs/archive/development/status/2026-09-06-airport-detailed-forecast-analysis.md`에 기록한다(실행 시 생성).
