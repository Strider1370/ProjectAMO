...
- 스펙: `docs/archive/development/specs/2026-08-02-flight-category-frontend-design.md`. 스펙에 없는 사용자 영향 결정을 새로 만들지 않는다.
- 선행 스펙: `docs/archive/development/specs/2026-08-01-flight-category-redesign-design.md`. 백엔드는 `325fa24`에서 완료됐다.
