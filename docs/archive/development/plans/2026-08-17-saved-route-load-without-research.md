...
`docs/archive/development/status/2026-08-17-saved-route-load-without-research.status.md`에 한 페이지로: 저장 경로별 payload 크기와 구간·마커 수, 해외 IFR 브리핑 스크린샷 경로, 네트워크 탭 확인 결과, 남은 위험.

- [ ] **Step 8: 커밋**

```bash
git add docs/archive/development/status/2026-08-17-saved-route-load-without-research.status.md
