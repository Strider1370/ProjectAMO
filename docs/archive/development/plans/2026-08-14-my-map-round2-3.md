...
**Spec:** `docs/archive/development/specs/2026-08-14-my-map-design.md` (「범위 밖 → 다음 판으로 미루는 것」)
**1판 계획:** `docs/archive/development/plans/2026-08-14-my-map-round1.md`
**측정 근거:** `docs/archive/development/status/2026-08-12-kml-viewer-spike-findings.md`
