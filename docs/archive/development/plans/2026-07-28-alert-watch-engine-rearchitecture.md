...
**Spec:** `docs/archive/development/specs/2026-07-28-alert-watch-engine-rearchitecture.md`
...
- Create: `docs/archive/development/status/alert-watch-engine-rearchitecture.status.md`
...
git add \
  ...
  docs/archive/development/specs/2026-07-28-alert-watch-engine-rearchitecture.md \
  docs/archive/development/plans/2026-07-28-alert-watch-engine-rearchitecture.md \
  docs/archive/development/status/alert-watch-engine-rearchitecture.status.md
