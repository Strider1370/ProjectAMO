...
- Use the exact approved copy from `docs/archive/development/specs/2026-07-31-terminal-passenger-signage-redesign.md`; do not reintroduce “예정”, repeated `KST`, or long explanatory labels.
