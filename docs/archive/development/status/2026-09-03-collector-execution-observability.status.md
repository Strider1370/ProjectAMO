...
Spec: `docs/archive/development/specs/2026-08-31-collector-execution-observability-design.md`
Plan: `docs/archive/development/plans/2026-08-31-collector-execution-observability.md`
...
- `docs/archive/development/plans/2026-08-31-collector-execution-observability.md`: `maxRetries`를 `maxAttempts`로 계약 동기화. 이 상태 문서도 함께 검토·커밋한다.
