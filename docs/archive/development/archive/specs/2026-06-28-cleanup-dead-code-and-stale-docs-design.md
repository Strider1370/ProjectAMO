...
- `docs/archive/development/status/kim-cloud-potential.status.md`
- `docs/archive/development/status/kim-icing-potential.status.md`
- `docs/archive/development/status/airport-weather-display-unification.status.md`
- `docs/archive/development/plans/2026-05-20-kim-nwp-server-ops-optimization.md`
- `docs/archive/development/specs/2026-05-18-kim-nwp-weather-layers-outline.md`
- `docs/archive/development/specs/2026-05-19-kim-temp-layer-design.md`

**삭제:**
- `docs/optimization-review-2026-05-20.md` (제안 항목 전부 shipped, 참조 0)

**위치 오류 정정:**
- `frontend/docs/archive/development/plans/2026-06-09-weather-layer-timestamp-bar.md` (frontend 안에 잘못 들어간 사본 — 삭제 또는 정규 위치로 이동)

**검증 후 결정 (참조 살아있음 / 불명확):**
- `docs/briefing-architecture.md` — 구현 전 초안, README 참조 중. 현재 `backend/src/briefing/`와 대조 후 갱신·통합·보존 결정
- `docs/specs/flight-category-overlay.md` — 비표준 위치. §8 open items 코드 해결 여부 확인 후 `docs/archive/development/specs/`로 이동 or archive
- `docs/archive/development/plans/2026-06-06-vertical-cross-section-overlay.md` — 6월 말 브리핑 개편에 밀렸는지 확인(`cross-section` 엔드포인트 존재 여부)
...
- `docs/archive/development/archive/**` — 이미 보관처
...
4. archive 이동 6건 완료, `docs/archive/development/status/`에 완료된 status 잔존 0
