...
- 연계 스펙:
  - `docs/archive/development/specs/2026-07-14-weather-aware-route-alternatives.md`
  - `docs/archive/development/specs/2026-07-15-altitude-advisor.md`
  - `docs/archive/development/specs/2026-07-15-navlog-leg-table.md`
  - `docs/archive/development/specs/2026-07-16-aip-airway-data-pipeline.md`
...
- [ ] `docs/archive/development/status/preflight-weather-briefing-flow.status.md`를 작업 완료마다 Resume Point와 검증 결과로 갱신한다.
