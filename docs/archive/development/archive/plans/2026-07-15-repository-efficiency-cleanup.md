...
- 계획 실행에는 기존 `docs/archive/development/status/repo-efficiency-audit.status.md`를 이어 사용하고, 각 Task 완료 시 Resume Point만 갱신한다.
...
**Files:**
- Modify: `docs/archive/development/status/repo-efficiency-audit.status.md`
...
Expected: `docs/archive/development/status/repo-efficiency-audit.status.md` remains under one page and contains only actual execution values.
...
**Files:**
- Move: `docs/archive/development/status/2026-07-07-dev-mode-console-status.md` → `docs/archive/development/status/archive/2026-07-07-dev-mode-console-status.md`
- Move: `docs/archive/development/status/cleanup-dead-code-and-stale-docs.status.md` → `docs/archive/development/status/archive/cleanup-dead-code-and-stale-docs.status.md`
- Move: `docs/archive/development/status/overseas-data-research.md` → `docs/research/2026-07-05-overseas-data-research.md`
- Move: `status.md` → `docs/archive/development/status/2026-07-07-route-forecast-alert.status.md`
- Move: `tasks/design-system-phase1/plan.md` → `docs/archive/development/archive/plans/2026-06-28-design-system-phase1.md`
- Move: `docs/archive/development/plans/fixtures/` → `frontend/test/fixtures/route-import/`
...
```powershell
git status --short -- docs/archive/development/status docs/research tasks status.md frontend/test docs/archive/development/plans/fixtures frontend/scripts
...
```powershell
git mv docs/archive/development/status/2026-07-07-dev-mode-console-status.md docs/archive/development/status/archive/2026-07-07-dev-mode-console-status.md
git mv docs/archive/development/status/cleanup-dead-code-and-stale-docs.status.md docs/archive/development/status/archive/cleanup-dead-code-and-stale-docs.status.md
git mv docs/archive/development/status/overseas-data-research.md docs/research/2026-07-05-overseas-data-research.md
git mv status.md docs/archive/development/status/2026-07-07-route-forecast-alert.status.md
git mv tasks/design-system-phase1/plan.md docs/archive/development/archive/plans/2026-06-28-design-system-phase1.md
git mv docs/archive/development/plans/fixtures frontend/test/fixtures/route-import
```
...
2. Update `docs/archive/development/plans/overseas-weather-and-fir.md:5` and `docs/archive/development/plans/overseas-noaa-integration.md:8` to `docs/research/2026-07-05-overseas-data-research.md`.
...
5. In `docs/archive/development/archive/plans/2026-07-02-route-file-import.md:994,1015-1017,1023,1047,1063,1103`, replace every old fixture path and the machine-specific prefix with `frontend/test/fixtures/route-import/...`.
...
rg -n --fixed-strings 'docs/archive/development/plans/fixtures' frontend scripts docs/archive/development/archive/plans/2026-07-02-route-file-import.md
rg -n '\]\(\.\./plans/' docs/archive/development/status/archive/2026-07-07-dev-mode-console-status.md
```
...
```powershell
git add -- docs/archive/development/status/archive/2026-07-07-dev-mode-console-status.md docs/archive/development/status/archive/cleanup-dead-code-and-stale-docs.status.md docs/research/2026-07-05-overseas-data-research.md docs/archive/development/status/2026-07-07-route-forecast-alert.status.md docs/archive/development/archive/plans/2026-06-28-design-system-phase1.md docs/archive/development/plans/overseas-weather-and-fir.md docs/archive/development/plans/overseas-noaa-integration.md docs/archive/development/archive/plans/2026-07-02-route-file-import.md frontend/test/fixtures/route-import frontend/scripts/route-import-capture.mjs frontend/scripts/route-import-real-files-capture.mjs
...
rg -n "C:\\Users\\Jond Doe|docs/archive/development/plans/fixtures" frontend scripts docs --glob '!docs/research/2026-07-15-repository-efficiency-audit.md' --glob '!docs/archive/development/plans/2026-07-15-repository-efficiency-cleanup.md'
```
...
```powershell
git add -- Architecture.md docs/archive/development/status/repo-efficiency-audit.status.md
...
```powershell
git status --short -- Architecture.md docs/archive/development/status/repo-efficiency-audit.status.md
```
...
```powershell
$status = Get-Content -Raw docs/archive/development/status/repo-efficiency-audit.status.md
...
**Files:**
- Move: `docs/archive/development/status/repo-efficiency-audit.status.md` → `docs/archive/development/status/archive/repo-efficiency-audit.status.md`
- Update generated graph: `graphify-out/`
...
```powershell
git mv docs/archive/development/status/repo-efficiency-audit.status.md docs/archive/development/status/archive/repo-efficiency-audit.status.md
git add -- docs/archive/development/status/archive/repo-efficiency-audit.status.md
