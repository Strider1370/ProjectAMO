...
**Spec:** `docs/archive/development/specs/2026-07-21-route-design-identity-and-detail.md`
...
**Files:**
- Modify: `docs/archive/development/status/route-design-identity-and-detail.status.md`(작성)
...
- [ ] Step 5: `docs/archive/development/status/route-design-identity-and-detail.status.md` 작성 — 완료 커밋, 검증 결과 기록.
- [ ] Step 6: Commit.
