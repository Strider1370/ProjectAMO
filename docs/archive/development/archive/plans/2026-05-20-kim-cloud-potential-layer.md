...
**Spec:** `docs/archive/development/specs/2026-05-20-kim-cloud-potential-layer.md`
...
- Existing outline: `docs/archive/development/specs/2026-05-18-kim-nwp-weather-layers-outline.md` Phase 4 already defines cloud potential using `T/rh` and `T - Td`.
- Existing temperature design: `docs/archive/development/specs/2026-05-19-kim-temp-layer-design.md` added `T` to the shared `kim_nwp` store.
...
Plan complete and saved to `docs/archive/development/plans/2026-05-20-kim-cloud-potential-layer.md`.
