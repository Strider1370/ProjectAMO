...
**Spec:** `docs/archive/development/specs/2026-07-15-navlog-leg-table.md`
...
- Modify: `docs/archive/development/specs/2026-07-15-navlog-leg-table.md:172-197` only if implementation reveals a spec/code mismatch
...
```powershell
git add Architecture.md docs/archive/development/specs/2026-07-15-navlog-leg-table.md graphify-out
