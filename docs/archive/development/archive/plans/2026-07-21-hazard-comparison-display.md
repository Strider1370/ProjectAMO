...
**Spec:** `docs/archive/development/specs/2026-07-21-hazard-comparison-display.md`
...
**Files:**
- Modify: `docs/archive/development/status/hazard-comparison-display.status.md`(작성)
...
- [ ] Step 5: `docs/archive/development/status/hazard-comparison-display.status.md` 작성 — 완료 커밋, 검증 결과, 스킵한 항목 기록.
- [ ] Step 6: Commit — `git add frontend/verification/route-fixture.mjs docs/archive/development/status/hazard-comparison-display.status.md && git commit -m "Add hazard fixtures and record verification"`.
