...
**Spec:** `docs/archive/development/specs/2026-07-23-satellite-convective-layers.md`\
**Supersedes:** `docs/archive/development/plans/2026-07-23-satellite-convective-layers.md`\
...
- Modify: `docs/archive/development/status/satellite-convective-layers.status.md`
