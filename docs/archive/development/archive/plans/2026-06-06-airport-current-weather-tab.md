...
- `docs/archive/development/specs/2026-06-06-airport-current-weather-tab-design.md`
...
```powershell
git diff -- frontend/src/features/airport-panel docs/archive/development Architecture.md
```
