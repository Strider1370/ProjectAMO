...
Plan: docs/archive/development/archive/plans/2026-06-28-workflow-constitution-redesign.md
...
## Notes
- 과거 기록(`docs/archive/development/specs|plans|status/`)의 codex 언급은 불변 이력으로 보존(작성 당시 사실). 일부는 Phase 2에서 archive 예정.
