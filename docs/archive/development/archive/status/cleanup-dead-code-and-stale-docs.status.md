...
Spec: docs/archive/development/specs/2026-06-28-cleanup-dead-code-and-stale-docs-design.md
...
- 위치정정: 잘못 들어간 `frontend/docs/.../2026-06-09-weather-layer-timestamp-bar.md` → 정규 `docs/archive/development/plans/`
