...
import { Settings, Bell, ChevronRight, Search, User, Wrench, MapPinned } from 'lucide-react'
...
export default function MobileMoreMenu({ onSearch, onMyMap, onSettings, onUpdates, onAccount, hasUpdate }) {
  const { user } = useAuth()
  ...
  const items = [
    ...
    { id: 'my-map', label: '내 지도', icon: MapPinned, onClick: onMyMap },
