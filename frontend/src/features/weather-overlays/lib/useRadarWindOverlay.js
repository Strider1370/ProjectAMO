...
export function deriveRadarWindOverlayState({ radarHsrEnabled, exactFrameAvailable }) {
  const nextRequestedVisible = Boolean(radarHsrEnabled)
  return {
...
export default function useRadarWindOverlay({ radarHsrEnabled, exactFrameAvailable }) {
  ...
  return { ...state, heightM, setHeightM }
}
