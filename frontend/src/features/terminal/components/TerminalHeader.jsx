...
export function TerminalHeader({ view, motionMode, page, pageCount, onViewChange, onMotionChange, onAdvance }) {
  ...
  return <>
    ...
    <header className={isBoard ? 'board-header' : 'rail-header'}>
      ...
      {isBoard ? <div className="board-header-clock"><span>한국 시각</span><strong>06:32</strong><small>2026-07-30 (목) · KST</small></div> : <div className="rail-header-clock"><span>한국 시각</span><strong>09:15</strong><small>2026-07-30 (목)</small><b>KST</b></div>}
    </header>
  </>
}
