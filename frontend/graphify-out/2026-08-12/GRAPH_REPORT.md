...
## Corpus Check
- 512 files · ~2,204,844 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2766 nodes · 6118 edges · 184 communities (142 shown, 42 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 135 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cf4968c3`
...
Cohesion: 0.05
Nodes (78): buildHashEntry(), buildOverlayMetaEntry(), buildSnapshotMetaFromData(), DEFERRED_WEATHER_FETCHERS, fetchConvectiveCtpsPoint(), fetchEchoTopPoint(), fetchJson(), fetchJsonWithXhr() (+70 more)
...
Cohesion: 0.06
Nodes (43): AXIS_LABEL, AXIS_LETTERS, AXIS_MAX, COORD_FORMAT_OPTIONS, COORD_PLACEHOLDER, formatCoordinate(), HEMI, parseCoordinate() (+35 more)

### Community 5 - "alert-triggers.js"
Cohesion: 0.05
Nodes (49): BY_RANK, describe(), FIELD_LABEL, highWind, lightningDetected, lowCeiling, RANK, tafAdverseWeather (+41 more)
...
Cohesion: 0.07
Nodes (24): fetchAdsbData(), BasemapSwitcher(), createOneShotNotifier(), BASEMAP_OPTIONS, MAP_CONFIG, BriefingView, FLIGHT_CATEGORY_LEGEND_BANDS, FLIGHT_CATEGORY_STATION_LEGEND_BANDS (+16 more)

### Community 12 - "notamLayers.js"
Cohesion: 0.09
Nodes (26): addNotamHighlight(), addNotamLayers(), CAT_SVG, CATEGORY_LABEL, catIconSvg(), catLabel(), EMPTY_FC, geometryContains() (+18 more)

### Community 13 - "routePreview.js"
Cohesion: 0.11
Nodes (24): addProcedurePreviewLayers(), addRoutePreviewLayers(), addVfrWaypointLayers(), augmentRouteWithProcedures(), bindIfrClickInteraction(), bindVfrInteractions(), buildProcedureGeoJSON(), buildVfrGeoJSON() (+16 more)
...
Cohesion: 0.15
Nodes (27): KNOWN_AIRPORTS, recommendProcedures(), base, BOUNDARY_FIX_FLOW_LABELS, buildBoundaryFixOptions(), buildIapCandidates(), buildIfrDistanceBreakdown(), buildInitialVfrWaypoints() (+19 more)

### Community 19 - "mapLayerUtils.js"
Cohesion: 0.17
Nodes (13): ConvectiveOverlayControls(), ITEMS, label(), MIN_FL_OPTIONS, LevelSlider(), LevelSliderPanel(), flightLevelForPressure(), formatPressureFlightLevel() (+5 more)
...
Cohesion: 0.15
Nodes (25): isothermSegments(), msToKt(), pressureToFallbackFt(), windBarbFeathers(), windDirectionFromUV(), ADVISORY_COLORS, assignMarkerLanes(), buildPath() (+17 more)
...
Cohesion: 0.14
Nodes (15): LayerToggleChips(), formatBriefingTime(), pad2(), buildIfrSequenceTokens(), ROUTE_SEQUENCE_COLORS, loadOverseasAirports(), AIRPORT_KO, DOMESTIC_AIRPORT_OPTIONS (+7 more)

### Community 25 - "weatherOverlayLayers.js"
Cohesion: 0.12
Nodes (25): addAdvisoryLayers(), setAdvisoryVisibility(), updateAdvisoryLayerData(), addedMapImages, addOrUpdateSigwxLowLayers(), bindSigwxStyleImageMissing(), buildSigwxDashArrayExpression(), createSigwxChipImage() (+17 more)
...
Cohesion: 0.18
Nodes (11): computeEtaIso(), buildRouteComparison(), getFinalRouteGeometry(), HAZARD_KO, PHENOMENON_LABEL_KO, QUALIFIER_ABBREVIATION, routeDistance(), snapshotMatches() (+3 more)
...
Cohesion: 0.07
Nodes (18): alternateBoardFlights, alternateRailFlights, BoardColumn(), boardFlightGroups, boardFlights, boardForecastAssets, boardMotionModes, boardWeatherAssets (+10 more)
...
Cohesion: 0.12
Nodes (15): AIRMET_FILTER_LABELS, ALERT_USER_SECTIONS, SIGMET_FILTER_LABELS, SIGWX_FILTER_LABELS, TRAFFIC_ALTITUDE_OPTIONS, TRIGGER_LABELS, AIRMET_CODE_TO_KEY, AIRMET_FILTER_GROUPS (+7 more)
...
Cohesion: 0.08
Nodes (36): assignTyphoonColors(), TYPHOON_PALETTE, addTyphoonLayers(), buildTyphoonGeoJson(), empty(), isSameRow(), ringsFor(), setTyphoonVisibility() (+28 more)
...
Cohesion: 0.18
Nodes (15): CHANGELOG, UpdatesModal(), DeveloperConsole(), useStyles, SettingsModal(), applyFont(), ensureFontLoaded(), FONT_OPTIONS (+7 more)
...
Cohesion: 0.14
Nodes (19): ALL_ACTIONS, AVIATION_ACTIONS, AVIATION_META, aviationLabel(), BASEMAP_ACTIONS, BASEMAP_META, buildRouteAviationLayerChips(), buildSearchCatalog() (+11 more)

### Community 45 - "notamGeoJson.js"
Cohesion: 0.05
Nodes (61): catLabelOf(), NotamTab(), altitudeOverlaps(), bboxNear(), escapeRegExp(), geometryBbox(), matchMoaActivation(), moaMatchKey() (+53 more)
...
Cohesion: 0.10
Nodes (20): AIRPORT_NAME_KO, AIRPORT_HEADER_NAME_KO, AirportPanel(), FULL_FEATURE_AIRPORTS, SECTION_ICON, buildCurrentWarningModel(), pickWarningName(), WARNING_NAME_KO (+12 more)
...
Cohesion: 0.16
Nodes (13): AVIATION_PANEL_MERGE_GROUPS, AVIATION_WFS_LAYERS, TMA_CITY_KO, TMA_CITY_KO_MATCH, TMA_LABEL_MATCH, AVIATION_TILE_META, colorById, buildTicks() (+5 more)

### Community 56 - "MonitoringPage.jsx"
Cohesion: 0.14
Nodes (14): Sidebar(), AlertSound(), BEEP_FREQ, Settings(), Header(), getDefaultAdvisoryFilterSettings(), loadAdvisoryFilterSettings(), canvasScale() (+6 more)
...
Cohesion: 0.27
Nodes (11): buildTafTacLines(), buildTafViewModel(), formatTafHour(), formatTafPeriodRange(), groupTafSlots(), TAF_CATEGORY_COLOR, computeColumnSpans(), EnhancedTafTab() (+3 more)

### Community 59 - "useIsMobile"
Cohesion: 0.12
Nodes (18): AviationLayerPanel(), GROUPS, LAYER_LABELS, entriesLeftToRight(), CI_LEGEND, CTPS_LEGEND, HLegend(), css (+10 more)
...
Cohesion: 0.24
Nodes (11): applyData(), arrowTip(), buildMotionHeadGeoJSON(), buildMotionShaftGeoJSON(), EMPTY, ensureArrowImage(), ensureLayers(), getState() (+3 more)

### Community 62 - "MonitoringPage"
Cohesion: 0.47
Nodes (6): buildMonitoringSnapshot(), detectMonitoringSnapshotChanges(), hashOf(), nextMonitoringSnapshot(), overlayKey(), tmOf()

### Community 63 - "notamViewModel.js"
Cohesion: 0.16
Nodes (14): bindFlightCategoryClick(), EMPTY_FC, ensure(), FC_LAYER_IDS, FC_SOURCE_IDS, filterMissing(), HAS_RING, removeFlightCategoryLayers() (+6 more)
...
Cohesion: 0.21
Nodes (15): collectGeometry(), detectFileKind(), disambiguateDuplicateLabels(), extractGeoJsonPaths(), extractGpxPaths(), extractRoutePaths(), isWithinKoreaFir(), KOREA_FIR_BOUNDS (+7 more)
...
Cohesion: 0.24
Nodes (15): addAviationWfsLayers(), addFirLabelLayer(), addHoverLayer(), addPointLabelLayer(), addPointLayer(), addPolygonLabelLayer(), addRouteLabelLayer(), combineFilter() (+7 more)
...
Cohesion: 0.28
Nodes (14): createCanvasImage(), createStationImage(), createWeatherImage(), createWindBarbImage(), ensureMapImage(), fillStationCover(), getPixelRatio(), loadImageElement() (+6 more)
...
Cohesion: 0.16
Nodes (19): addAirportLayers(), addGeoBoundaryLayers(), AIRPORT_INTERACTIVE_LAYERS, BASE_MAP_LAYER_IDS, GEO_LAYERS, geoLayerInZoomRange(), geoZoomHandlers, loadGeoSourcesForZoom() (+11 more)

### Community 78 - "AltitudeWeatherComparison.jsx"
Cohesion: 0.29
Nodes (12): AltitudeWeatherComparison(), constraintLabel(), formatAltitude(), hasSeverity(), SEVERITY_LABEL, severityBadge(), warningMessages(), exposureNm() (+4 more)
...
Cohesion: 0.53
Nodes (5): addRasterLayer(), coverageUrl(), RAINVIEWER_LEGEND, syncRainviewerLayers(), tileUrl()
...
Cohesion: 0.26
Nodes (14): get(), getNotifications(), getProcessorLog(), getRequestLog(), getSnapshotMeta(), getStoreStats(), getVitals(), hhmmss() (+6 more)
...
Cohesion: 0.16
Nodes (10): here, installFixture(), openWeatherPanel(), OVERLAY_FIXTURE, panelToggle(), POINT_FIXTURE, revealLegends(), SCREENSHOT_TOLERANCE (+2 more)
...
Cohesion: 0.27
Nodes (12): airportNames(), compactAirportName(), fetchOptional(), finiteNumber(), formatWind(), koreanWindDirection(), loadTerminalLiveWeatherData(), mergeTerminalLiveWeather() (+4 more)

### Community 102 - "port-guard.mjs"
Cohesion: 0.22
Nodes (10): ADSB_LAYER_IDS, ADSB_SOURCE_IDS, BASE_MAP_SOURCE_IDS, bindLayerEvent(), cleanupAll(), flattenLayerIds(), hasStyleRevision(), bindSectorHover() (+2 more)
...
Cohesion: 0.21
Nodes (9): DeveloperConsole, MobileMoreMenu(), authApi(), AuthContext, AuthProvider(), JSON_HEADERS, ROLE_LABEL_KO, AuthModal() (+1 more)
...
Cohesion: 0.23
Nodes (10): metLabel(), HazardIcon(), hazardMapLayers(), RULEBOOK, mergeExposureNm(), formatRouteString(), exposureLabel(), hazardChipClassName() (+2 more)
...
Cohesion: 0.40
Nodes (8): bySavedDesc(), deleteSavedRoute(), listSavedRoutes(), normalizeRouteSnapshot(), persistedDesign(), read(), saveRoute(), write()

### Community 143 - "notamSchedule.test.js"
Cohesion: 0.29
Nodes (6): App(), formatKoreanClock(), departureAirportFromPathname(), selectTerminalDepartureAirport(), TERMINAL_DEPARTURE_ICAOS, airports
...
Cohesion: 0.25
Nodes (5): geometryBounds(), setNotamCategoryFilter(), ALL, feats, square
...
Cohesion: 0.48
Nodes (5): deepMerge(), loadPersonalSettings(), migratePersonalSettings(), resolveSettings(), savePersonalSettings()

### Community 181 - "DeveloperPage.jsx"
Cohesion: 0.23
Nodes (8): bottomItems, PANEL_MAP, topItems, getHealth(), DeveloperConsole, DeveloperConsoleButton(), DeveloperPage(), useStyles

### Community 182 - "flightCategoryLegend.js"
Cohesion: 0.53
Nodes (4): hhmmInTz(), legendStamps(), parseUtcTm(), sources

## Knowledge Gaps
- **537 isolated node(s):** `name`, `private`, `version`, `type`, `node` (+532 more)
...
- **Why does `useRouteBriefing()` connect `routeBriefingModel.js` to `routePlanner.js`, `mobile-audit-capture.mjs`, `useRouteBriefing.js`, `MapView.jsx`, `manualRouteInput.js`, `verticalProfileRequest.js`, `aircraftProfiles.js`, `useRouteBriefing`, `hazardMapLayers`, `procedureData.js`, `createRouteEditor`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `airport()` connect `mobile-audit-capture.mjs` to `routeBriefingModel.js`, `flightCategoryLayers.js`, `notamSchedule.test.js`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `useTimeZone()` connect `AirportPanel.jsx` to `App.jsx`, `useTimeZone`, `alert-triggers.js`, `fluent.js`, `MapView.jsx`, `WeatherIcon.jsx`, `deriveNotamTime`, `RouteBriefingPanel.jsx`, `webglWindRenderer.js`, `BriefingView.jsx`?**
